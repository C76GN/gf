...
const GFNodeSerializerRegistryBase = preload("res://addons/gf/packages/official/save/serializers/gf_node_serializer_registry.gd")
const GFSaveEntityFactoryBase = preload("res://addons/gf/packages/official/save/core/gf_save_entity_factory.gd")
const GFSaveIdentityBase = preload("res://addons/gf/packages/official/save/core/gf_save_identity.gd")
const GFSavePipelineContextBase = preload("res://addons/gf/packages/official/save/pipeline/gf_save_pipeline_context.gd")
const GFSavePipelineStepBase = preload("res://addons/gf/packages/official/save/pipeline/gf_save_pipeline_step.gd")
const GFSaveScopeBase = preload("res://addons/gf/packages/official/save/core/gf_save_scope.gd")
const GFSaveSourceBase = preload("res://addons/gf/packages/official/save/core/gf_save_source.gd")
