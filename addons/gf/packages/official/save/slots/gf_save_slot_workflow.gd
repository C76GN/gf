...
const GFSaveSlotCardBase = preload("res://addons/gf/packages/official/save/slots/gf_save_slot_card.gd")
const GFSaveSlotMetadataBase = preload("res://addons/gf/packages/official/save/slots/gf_save_slot_metadata.gd")
