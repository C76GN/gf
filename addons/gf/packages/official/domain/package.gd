...
const GFLevelUtilityBase = preload("res://addons/gf/packages/official/domain/level/gf_level_utility.gd")
const GFQuestUtilityBase = preload("res://addons/gf/packages/official/domain/quest/gf_quest_utility.gd")
