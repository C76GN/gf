...
const GF_CAPABILITY_CONTAINER_SCRIPT_PATH: String = "res://addons/gf/packages/official/capability/nodes/gf_capability_container.gd"
const GF_NODE_CAPABILITY_SCRIPT_PATH: String = "res://addons/gf/packages/official/capability/nodes/gf_node_capability.gd"
const GF_NODE_2D_CAPABILITY_SCRIPT_PATH: String = "res://addons/gf/packages/official/capability/nodes/gf_node_2d_capability.gd"
const GF_NODE_3D_CAPABILITY_SCRIPT_PATH: String = "res://addons/gf/packages/official/capability/nodes/gf_node_3d_capability.gd"
const GF_CONTROL_CAPABILITY_SCRIPT_PATH: String = "res://addons/gf/packages/official/capability/nodes/gf_control_capability.gd"
const GF_CAPABILITY_RECIPE_SCRIPT_PATH: String = "res://addons/gf/packages/official/capability/recipes/gf_capability_recipe.gd"
...
func _can_handle(object: Object) -> bool:
	if not _is_capability_package_enabled():
		return false
...
func _collect_recipe_candidates() -> Array[Dictionary]:
	var candidates: Array[Dictionary] = []
	if not Engine.is_editor_hint() or not _is_capability_package_enabled():
		return candidates
...
func _is_capability_package_enabled() -> bool:
	return GF_PACKAGE_SETTINGS_BASE.is_package_enabled(CAPABILITY_PACKAGE_ID)
