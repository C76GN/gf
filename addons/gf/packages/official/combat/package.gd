...
const GFCombatSystemBase = preload("res://addons/gf/packages/official/combat/core/gf_combat_system.gd")
const GFSkillTargetingUtilityBase = preload("res://addons/gf/packages/official/combat/skills/gf_skill_targeting_utility.gd")
