...
## @param actions: 子动作列表。
## @return 顺序动作组。
static func sequence(actions: Array[GFVisualAction]) -> GFVisualActionGroup:
...
## @param actions: 子动作列表。
## @return 并行动作组。
static func parallel(actions: Array[GFVisualAction]) -> GFVisualActionGroup:
