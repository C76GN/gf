...
const GFCombatSystemBase = preload("res://addons/gf/extensions/combat/core/gf_combat_system.gd")
const GFSkillTargetingUtilityBase = preload("res://addons/gf/extensions/combat/skills/gf_skill_targeting_utility.gd")
