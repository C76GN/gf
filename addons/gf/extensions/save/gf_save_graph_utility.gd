...
const _GF_VALIDATION_UTILITY_SCRIPT = preload("res://addons/gf/foundation/validation/gf_validation_utility.gd")
...
func _finalize_diagnostic_report(report: Dictionary, subject: String) -> Dictionary:
	return _GF_VALIDATION_UTILITY_SCRIPT.finalize_report(report, subject, {
...
func _append_diagnostic_issue(
	...
	_GF_VALIDATION_UTILITY_SCRIPT.append_issue(report, severity, StringName(kind), message, {
		"key": key,
		"path": path,
	})
