...
##
## 负责把能力脚本记录贡献给 GFAccessGenerator，避免 kernel 硬编码官方扩展路径。
extends RefCounted


# --- 常量 ---

const GFAccessGeneratorBase = preload("res://addons/gf/kernel/editor/gf_access_generator.gd")
const _SCRIPT_TYPE_INSPECTOR: Script = preload("res://addons/gf/kernel/core/gf_script_type_inspector.gd")
const _BASE_CAPABILITY_SCRIPT: Script = preload("res://addons/gf/extensions/official/capability/core/gf_capability.gd")
const _BASE_NODE_CAPABILITY_SCRIPT: Script = preload("res://addons/gf/extensions/official/capability/nodes/gf_node_capability.gd")
const _BASE_NODE_2D_CAPABILITY_SCRIPT: Script = preload("res://addons/gf/extensions/official/capability/nodes/gf_node_2d_capability.gd")
const _BASE_NODE_3D_CAPABILITY_SCRIPT: Script = preload("res://addons/gf/extensions/official/capability/nodes/gf_node_3d_capability.gd")
const _BASE_CONTROL_CAPABILITY_SCRIPT: Script = preload("res://addons/gf/extensions/official/capability/nodes/gf_control_capability.gd")
const _CAPABILITY_UTILITY_SCRIPT_PATH: String = "res://addons/gf/extensions/official/capability/core/gf_capability_utility.gd"
...
func _make_access_record(class_name_value: String, path: String) -> Dictionary:
	return {
		...
		"path": path,
		"kind": GFAccessGeneratorBase.TargetKind.CAPABILITY,
