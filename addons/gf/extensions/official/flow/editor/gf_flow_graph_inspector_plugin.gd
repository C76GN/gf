...
const FLOW_EXTENSION_ID: String = "gf.official.flow"
const GF_FLOW_GRAPH_SCRIPT_PATH: String = "res://addons/gf/extensions/official/flow/resources/gf_flow_graph.gd"
...
func _can_handle(object: Object) -> bool:
	...
	var flow_graph_script := _get_flow_graph_script()
