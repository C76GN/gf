...
const GFTweenActionConfigBase = preload("res://addons/gf/extensions/official/action_queue/tween/gf_tween_action_config.gd")
const GFTweenActionStepBase = preload("res://addons/gf/extensions/official/action_queue/tween/gf_tween_action_step.gd")
