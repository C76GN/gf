...
const GF_SAVE_GRAPH_UTILITY_BASE := preload("res://addons/gf/extensions/official/save/graph/gf_save_graph_utility.gd")
const GF_SAVE_SCOPE_BASE := preload("res://addons/gf/extensions/official/save/core/gf_save_scope.gd")
