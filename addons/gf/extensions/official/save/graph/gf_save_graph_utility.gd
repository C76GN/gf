...
const GFNodeSerializerRegistryBase = preload("res://addons/gf/extensions/official/save/serializers/gf_node_serializer_registry.gd")
const GFSaveEntityFactoryBase = preload("res://addons/gf/extensions/official/save/core/gf_save_entity_factory.gd")
const GFSaveIdentityBase = preload("res://addons/gf/extensions/official/save/core/gf_save_identity.gd")
const GFSavePipelineContextBase = preload("res://addons/gf/extensions/official/save/pipeline/gf_save_pipeline_context.gd")
const GFSavePipelineStepBase = preload("res://addons/gf/extensions/official/save/pipeline/gf_save_pipeline_step.gd")
