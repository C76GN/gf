...
const GFRequestEnvelopeBase = preload("res://addons/gf/utilities/gf_request_envelope.gd")
...
func save_queue() -> Error:
	...
	var data := GFVariantUtility.variant_to_json_compatible(_to_storage_dict())
...
func load_queue() -> Error:
	...
	var data_value: Variant = GFVariantUtility.json_compatible_to_variant(parsed)
...
func _call_transport(envelope: GFRequestEnvelopeBase) -> Dictionary:
	...
	if value is Dictionary:
		var result := GFVariantUtility.duplicate_variant(value) as Dictionary
