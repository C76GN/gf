...
const CAPABILITY_INSPECTOR_PLUGIN_SCRIPT_PATH: String = "res://addons/gf/kernel/editor/gf_capability_inspector_plugin.gd"
const NODE_STATE_MACHINE_INSPECTOR_PLUGIN_SCRIPT_PATH: String = "res://addons/gf/kernel/editor/gf_node_state_machine_inspector_plugin.gd"
const FLOW_GRAPH_INSPECTOR_PLUGIN_SCRIPT_PATH: String = "res://addons/gf/kernel/editor/gf_flow_graph_inspector_plugin.gd"
const PATTERN_2D_INSPECTOR_PLUGIN_SCRIPT_PATH: String = "res://addons/gf/kernel/editor/gf_pattern_2d_inspector_plugin.gd"
const BUILD_INFO_EXPORT_PLUGIN_SCRIPT_PATH: String = "res://addons/gf/kernel/editor/gf_build_info_export_plugin.gd"
