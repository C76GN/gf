## 测试 GFTextFitUtility 的字体尺寸适配。
extends GutTest


# --- 常量 ---

const GFTextFitUtilityBase = preload("res://addons/gf/utilities/gf_text_fit_utility.gd")
...
func test_fit_label_applies_font_size_override() -> void:
	...
	var font_size: int = GFTextFitUtilityBase.fit_label(label, {
		"min_font_size": 8,
		"max_font_size": 28,
...
func test_fit_label_shrinks_to_available_width() -> void:
	...
	var measured_size: Vector2 = GFTextFitUtilityBase.measure_text(label, label.text, font_size, {
		"available_size": Vector2(90.0, 40.0),
	})
...
func test_fit_rich_text_label_uses_plain_text_measurement() -> void:
	...
	var font_size: int = GFTextFitUtilityBase.fit_rich_text_label(label, {
		"min_font_size": 8,
		"max_font_size": 26,
		"available_size": Vector2(200.0, 60.0),
	})
