...
const GFBlackboardEntryBase = preload("res://addons/gf/foundation/blackboard/gf_blackboard_entry.gd")
const GFBlackboardSchemaBase = preload("res://addons/gf/foundation/blackboard/gf_blackboard_schema.gd")
