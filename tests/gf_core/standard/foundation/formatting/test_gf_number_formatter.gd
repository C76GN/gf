...
const GF_BIG_NUMBER := preload("res://addons/gf/standard/foundation/numeric/gf_big_number.gd")
const GF_FIXED_DECIMAL := preload("res://addons/gf/standard/foundation/numeric/gf_fixed_decimal.gd")
const GF_NUMBER_FORMATTER := preload("res://addons/gf/standard/foundation/formatting/gf_number_formatter.gd")
