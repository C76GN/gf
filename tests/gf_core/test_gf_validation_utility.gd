...
const GF_VALIDATION_ISSUE_BASE := preload("res://addons/gf/foundation/validation/gf_validation_issue.gd")
const GF_VALIDATION_REPORT_BASE := preload("res://addons/gf/foundation/validation/gf_validation_report.gd")
const GF_VALIDATION_UTILITY_BASE := preload("res://addons/gf/foundation/validation/gf_validation_utility.gd")
...
func test_dictionary_report_finalize_preserves_existing_fields() -> void:
	...
	GF_VALIDATION_UTILITY_BASE.append_issue(report, "warning", &"missing_optional", "Optional field is missing.", {
		"row_key": 1,
	})

	GF_VALIDATION_UTILITY_BASE.finalize_report(report, "Config table")
