...
const GF_MOVE_TWEEN_ACTION := preload("res://addons/gf/packages/official/action_queue/actions/gf_move_tween_action.gd")
const GF_FLASH_ACTION := preload("res://addons/gf/packages/official/action_queue/actions/gf_flash_action.gd")
const GF_AUDIO_ACTION := preload("res://addons/gf/packages/official/action_queue/actions/gf_audio_action.gd")
const GF_CONFIGURED_TWEEN_ACTION := preload("res://addons/gf/packages/official/action_queue/actions/gf_configured_tween_action.gd")
const GF_TWEEN_ACTION_CONFIG := preload("res://addons/gf/packages/official/action_queue/tween/gf_tween_action_config.gd")
const GFTWEEN_ACTION_STEP := preload("res://addons/gf/packages/official/action_queue/tween/gf_tween_action_step.gd")
