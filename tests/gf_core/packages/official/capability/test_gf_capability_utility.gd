...
const GF_CAPABILITY_UTILITY_BASE := preload("res://addons/gf/packages/official/capability/core/gf_capability_utility.gd")
...
func test_interaction_context_queries_capabilities_and_group() -> void:
	...
	context.with_capability_provider(_utility)
