## 测试 Combat 包的通用发射体节点与策略资源。
extends GutTest


# --- 常量 ---

const GFLinearProjectileMotionBase = preload("res://addons/gf/packages/official/combat/projectiles/gf_linear_projectile_motion.gd")
const GFHomingProjectileMotionBase = preload("res://addons/gf/packages/official/combat/projectiles/gf_homing_projectile_motion.gd")
const GFProjectile2DBase = preload("res://addons/gf/packages/official/combat/projectiles/gf_projectile_2d.gd")
const GFProjectile3DBase = preload("res://addons/gf/packages/official/combat/projectiles/gf_projectile_3d.gd")
const GFProjectileLifetimePolicyBase = preload("res://addons/gf/packages/official/combat/projectiles/gf_projectile_lifetime_policy.gd")
