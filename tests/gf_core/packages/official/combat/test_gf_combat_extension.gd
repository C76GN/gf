...
func test_hit_box_state_2d_toggles_child_hit_and_hurt_boxes() -> void:
	var state := preload("res://addons/gf/packages/official/combat/hit_detection/gf_hit_box_state_2d.gd").new()
...
func test_hit_box_state_3d_can_manage_visibility_optionally() -> void:
	var state := preload("res://addons/gf/packages/official/combat/hit_detection/gf_hit_box_state_3d.gd").new()
