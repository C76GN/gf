...
const GFNetworkBackendBase = preload("res://addons/gf/packages/official/network/backends/gf_network_backend.gd")
const GFNetworkChannelBase = preload("res://addons/gf/packages/official/network/session/gf_network_channel.gd")
const GFENetNetworkBackendBase = preload("res://addons/gf/packages/official/network/backends/gf_enet_network_backend.gd")
const GFWebSocketNetworkBackendBase = preload("res://addons/gf/packages/official/network/backends/gf_websocket_network_backend.gd")
const GFNetworkMessageBase = preload("res://addons/gf/packages/official/network/messages/gf_network_message.gd")
const GFNetworkMessageValidatorBase = preload("res://addons/gf/packages/official/network/messages/gf_network_message_validator.gd")
const GFNetworkRateLimiterBase = preload("res://addons/gf/packages/official/network/session/gf_network_rate_limiter.gd")
const GFNetworkReconnectPolicyBase = preload("res://addons/gf/packages/official/network/session/gf_network_reconnect_policy.gd")
const GFNetworkSerializerBase = preload("res://addons/gf/packages/official/network/serialization/gf_network_serializer.gd")
const GFNetworkFieldSerializerBase = preload("res://addons/gf/packages/official/network/serialization/gf_network_field_serializer.gd")
const GFNetworkSnapshotSchemaBase = preload("res://addons/gf/packages/official/network/snapshot/gf_network_snapshot_schema.gd")
const GFNetworkUtilityBase = preload("res://addons/gf/packages/official/network/runtime/gf_network_utility.gd")
const GFFixedTickClockBase = preload("res://addons/gf/packages/official/network/simulation/gf_fixed_tick_clock.gd")
const GFNetworkHistoryBufferBase = preload("res://addons/gf/packages/official/network/snapshot/gf_network_history_buffer.gd")
const GFNetworkSnapshotBase = preload("res://addons/gf/packages/official/network/snapshot/gf_network_snapshot.gd")
