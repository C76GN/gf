...
const GF_CAPABILITY_UTILITY_BASE := preload("res://addons/gf/extensions/official/capability/core/gf_capability_utility.gd")
const GF_CAPABILITY_CONTAINER_BASE := preload("res://addons/gf/extensions/official/capability/nodes/gf_capability_container.gd")
const GF_CAPABILITY_RECIPE_BASE := preload("res://addons/gf/extensions/official/capability/recipes/gf_capability_recipe.gd")
const GF_CAPABILITY_RECIPE_ENTRY_BASE := preload("res://addons/gf/extensions/official/capability/recipes/gf_capability_recipe_entry.gd")
const GF_PROPERTY_BAG_CAPABILITY_BASE := preload("res://addons/gf/extensions/official/capability/core/gf_property_bag_capability.gd")
