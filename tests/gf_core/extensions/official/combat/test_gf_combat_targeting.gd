...
const GFSkill_ := preload("res://addons/gf/extensions/official/combat/skills/gf_skill.gd")
const GFTagComponent_ := preload("res://addons/gf/extensions/official/combat/tags/gf_tag_component.gd")
const GFModifiedAttribute_ := preload("res://addons/gf/extensions/official/combat/attributes/gf_modified_attribute.gd")
const GFSkillTargetingRule_ := preload("res://addons/gf/extensions/official/combat/skills/gf_skill_targeting_rule.gd")
const GFSkillTargetingUtility_ := preload("res://addons/gf/extensions/official/combat/skills/gf_skill_targeting_utility.gd")
