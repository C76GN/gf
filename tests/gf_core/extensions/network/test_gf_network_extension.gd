...
const GFNetworkBackendBase = preload("res://addons/gf/extensions/network/backends/gf_network_backend.gd")
const GFNetworkChannelBase = preload("res://addons/gf/extensions/network/session/gf_network_channel.gd")
const GFENetNetworkBackendBase = preload("res://addons/gf/extensions/network/backends/gf_enet_network_backend.gd")
const GFWebSocketNetworkBackendBase = preload("res://addons/gf/extensions/network/backends/gf_websocket_network_backend.gd")
const GFNetworkMessageBase = preload("res://addons/gf/extensions/network/messages/gf_network_message.gd")
...
const GFNetworkContractBase = preload("res://addons/gf/extensions/network/contracts/gf_network_contract.gd")
const GFNetworkContractFieldBase = preload("res://addons/gf/extensions/network/contracts/gf_network_contract_field.gd")
const GFNetworkContractGeneratorBase = preload("res://addons/gf/extensions/network/editor/gf_network_contract_generator.gd")
const GFNetworkContractMessageBase = preload("res://addons/gf/extensions/network/contracts/gf_network_contract_message.gd")
const GFNetworkUtilityBase = preload("res://addons/gf/extensions/network/runtime/gf_network_utility.gd")
const GFFixedTickClockBase = preload("res://addons/gf/extensions/network/simulation/gf_fixed_tick_clock.gd")
const GFNetworkHistoryBufferBase = preload("res://addons/gf/extensions/network/snapshot/gf_network_history_buffer.gd")
const GFNetworkSnapshotBase = preload("res://addons/gf/extensions/network/snapshot/gf_network_snapshot.gd")
