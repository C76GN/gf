...
const GFNodeStateBehaviorBase = preload("res://addons/gf/extensions/state_machine/gf_node_state_behavior.gd")
const GFNodeStateConditionBase = preload("res://addons/gf/extensions/state_machine/gf_node_state_condition.gd")
