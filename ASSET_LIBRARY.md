...
- Asset Version: `3.16.1`
- Download Commit/URL: `3.16.1`
- Icon URL: `https://raw.githubusercontent.com/C76GN/gf-framework/3.16.1/addons/gf/icon.png`
...
6. Create the GitHub Release from a no-prefix SemVer tag such as `3.16.1`.
