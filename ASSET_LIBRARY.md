...
- Asset Version: `4.1.0`
- Download Commit/URL: `4.1.0`
- Icon URL: `https://raw.githubusercontent.com/C76GN/gf-framework/4.1.0/addons/gf/icon.png`
...
4. Build the Asset Store package with `python tools\build_asset_store_package.py --version 4.1.0` and verify the zip root is `addons/`.
5. Run the GUT test suite on the target minimum Godot version.
6. Run `python tools\gf_maintenance.py release-status --version 4.1.0`.
7. Create the GitHub Release from a no-prefix SemVer tag such as `4.1.0`.
