...
- Asset Version: `3.13.0`
- Download Commit/URL: `3.13.0`
- Icon URL: `https://raw.githubusercontent.com/C76GN/gf-framework/3.13.0/addons/gf/icon.png`
...
6. Create the GitHub Release from a no-prefix SemVer tag such as `3.13.0`.
